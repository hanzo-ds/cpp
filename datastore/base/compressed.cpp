...
#include "output.h"
#include "datastore/exceptions.h"
...
// see DB::CompressionMethodByte from src/Compression/CompressionInfo.h of Datastore project
...
void CompressedOutput::Compress(const void * data, size_t len) {
    switch (method_) {  
    case datastore::CompressionMethod::LZ4: {
    ...
    case datastore::CompressionMethod::ZSTD: {
    ...
    case datastore::CompressionMethod::None: {
